...
contract AgentRegistry is IAgentRegistry, Pausable {
    ...
    function _buildDID(address agentWallet) internal view returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01020000, 1037618708738) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01020001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01020005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01026000, agentWallet) }
    ...
    function _chainLabel() internal view returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01030000, 1037618708739) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01030001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01030004, 0) }
    ...
    function _toHexString(address addr) internal pure returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01040000, 1037618708740) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01040001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01040005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01046000, addr) }
    ...
    function _uintToString(uint256 value) internal pure returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01050000, 1037618708741) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01050001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01050005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01056000, value) }
        if (value == 0) return "0";
        uint256 temp = value;
        uint256 digits;
