...
contract RevocationRegistry is IRevocationRegistry, AccessControl, Pausable {
    ...
    function _revoke(
        ...
        RevocationReason reason,
        string calldata notes
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01140000, 1037618708756) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01140001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01140005, 602) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01146102, notes.offset) }
    ...
    function _reinstate(
        ...
        string calldata notes
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01150000, 1037618708757) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01150001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01150005, 602) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01156102, notes.offset) }
        rec.revoked      = false;
