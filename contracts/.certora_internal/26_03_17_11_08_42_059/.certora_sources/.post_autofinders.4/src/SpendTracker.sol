...
contract SpendTracker is ISpendTracker, AccessControl, Pausable {
    ...
    function _getUSDValue(address token, uint256 amount) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01430000, 1037618708803) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01430001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01430005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01436001, amount) }
        address feedAddr = _priceFeeds[token];
        require(feedAddr != address(0), "SpendTracker: no price feed for token");
