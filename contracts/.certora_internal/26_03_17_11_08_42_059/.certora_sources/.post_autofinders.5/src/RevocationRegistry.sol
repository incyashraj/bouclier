...
contract RevocationRegistry is IRevocationRegistry, AccessControl, Pausable {
    ...
    function _revoke(
        ...
        RevocationReason reason,
        string calldata notes
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02240000, 1037618709028) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02240001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02240005, 602) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02246102, notes.offset) }
    ...
    function _reinstate(
        ...
        string calldata notes
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02250000, 1037618709029) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02250001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02250005, 602) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02256102, notes.offset) }
