    ...
    EIP712("BouclierPermissionVault", "1")
{
        ...
        returns (uint256 validationData)
    {
        ...
        (
            ...
            uint256 tokenAmount
        ) = _decodeCallData(userOp.callData);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010029,0)}

        bytes32 actionHash = keccak256(abi.encode(userOp.sender, target, selector, userOpHash));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002a,actionHash)}

        // ── Step 2: Resolve agentId ───────────────────────────────
        bytes32 agentId = agentRegistry.getAgentId(userOp.sender);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002b,agentId)}
        ...
        PermissionScope storage scope = _scopes[agentId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001002c,0)}
        ...
        uint256 usdValue = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002d,usdValue)}
    ...
    function grantPermission(
        ...
        AgentRecord memory rec = agentRegistry.resolve(agentId);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001002e,0)}
        ...
        uint256 nonce = grantNonces[agentId]++;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002f,nonce)}
        bytes32 structHash = keccak256(abi.encode(
            ...
            scope.allowAnyToken
        ));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000030,structHash)}
        bytes32 digest = _hashTypedDataV4(structHash);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000031,digest)}
        address signer = digest.recover(ownerSignature);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000032,signer)}
        ...
        PermissionScope storage stored = _scopes[agentId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010033,0)}
        // Copy all fields
        stored.agentId           = scope.agentId;bytes32 certora_local60 = stored.agentId;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003c,certora_local60)}
        stored.dailySpendCapUSD  = scope.dailySpendCapUSD;uint256 certora_local61 = stored.dailySpendCapUSD;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003d,certora_local61)}
        stored.perTxSpendCapUSD  = scope.perTxSpendCapUSD;uint256 certora_local62 = stored.perTxSpendCapUSD;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003e,certora_local62)}
        stored.validFrom         = scope.validFrom;uint48 certora_local63 = stored.validFrom;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003f,certora_local63)}
        stored.validUntil        = scope.validUntil;uint48 certora_local64 = stored.validUntil;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000040,certora_local64)}
        stored.allowAnyProtocol  = scope.allowAnyProtocol;bool certora_local65 = stored.allowAnyProtocol;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000041,certora_local65)}
        stored.allowAnyToken     = scope.allowAnyToken;bool certora_local66 = stored.allowAnyToken;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000042,certora_local66)}
        stored.revoked           = false;bool certora_local67 = stored.revoked;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000043,certora_local67)}
        stored.windowStartHour   = scope.windowStartHour;uint8 certora_local68 = stored.windowStartHour;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000044,certora_local68)}
        stored.windowEndHour     = scope.windowEndHour;uint8 certora_local69 = stored.windowEndHour;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000045,certora_local69)}
        stored.windowDaysMask    = scope.windowDaysMask;uint8 certora_local70 = stored.windowDaysMask;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000046,certora_local70)}
        stored.allowedChainId    = scope.allowedChainId;uint64 certora_local71 = stored.allowedChainId;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000047,certora_local71)}
        stored.grantHash         = digest;bytes32 certora_local72 = stored.grantHash;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000048,certora_local72)}
    ...
    function revokePermission(bytes32 agentId) external {
        AgentRecord memory rec = agentRegistry.resolve(agentId);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010034,0)}
        require(
            rec.owner == msg.sender || msg.sender == owner(),
            "PermissionVault: not agent owner"
        );
    ...
    function emergencyRevoke(bytes32 agentId) external {
        AgentRecord memory rec = agentRegistry.resolve(agentId);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010035,0)}
        require(
            rec.owner == msg.sender || msg.sender == owner(),
            "PermissionVault: not agent owner"
        );
    ...
    ) internal returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00390000, 1037618708537) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00390001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00390005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00396003, violationType) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003a0000, 1037618708538) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003a0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003a0005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003a6100, callData.offset) }
        ...
        bytes4 outerSel = bytes4(callData[:4]);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000036,outerSel)}
        ...
        selector    = outerSel;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000049,selector)}
        target      = address(0);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004a,target)}
        tokenAddress = address(0);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004b,tokenAddress)}
        tokenAmount  = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004c,tokenAmount)}
    }

    function _slice(bytes memory data, uint256 start) internal pure returns (bytes memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003c0000, 1037618708540) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003c0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003c0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003c6001, start) }
        require(data.length >= start, "slice out of bounds");
        bytes memory result = new bytes(data.length - start);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010037,0)}
        for (uint256 i; i < result.length; ++i) {
            result[i] = data[start + i];bytes1 certora_local77 = result[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004d,certora_local77)}
        }
        return result;
    }

    function _inAddressArray(address[] storage arr, address val) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003d0000, 1037618708541) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003d0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003d0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003d6001, val) }
        uint256 len = arr.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000038,len)}
    ...
    function _inSelectorArray(bytes4[] storage arr, bytes4 val) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003b0000, 1037618708539) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003b0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003b0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003b6001, val) }
        uint256 len = arr.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000039,len)}
        for (uint256 i; i < len; ++i) {
            if (arr[i] == val) return true;
        }
        return false;
    ...
    function rescueETH(address payable recipient) external onlyOwner {
        ...
        uint256 bal = address(this).balance;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003a,bal)}
        require(bal > 0, "PermissionVault: no ETH to rescue");
        // slither-disable-next-line low-level-calls
        (bool ok,) = recipient.call{value: bal}("");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001003b,0)}
