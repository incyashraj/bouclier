...
contract AgentRegistry is IAgentRegistry, Pausable {
    ...
    function _buildDID(address agentWallet) internal view returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02060000, 1037618708998) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02060001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02060005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02066000, agentWallet) }
    ...
    function _chainLabel() internal view returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02070000, 1037618708999) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02070001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02070004, 0) }
    ...
    function _toHexString(address addr) internal pure returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02080000, 1037618709000) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02080001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02080005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02086000, addr) }
