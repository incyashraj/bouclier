...
contract SpendTracker is ISpendTracker, AccessControl, Pausable {
    ...
    function recordSpend(
        ...
        uint256 pos = _head[agentId] % MAX_ENTRIES;
        ...
        uint256 rolling = _getRollingSpend(agentId, 86400);
    ...
    function _getRollingSpend(bytes32 agentId, uint256 windowSeconds) internal view returns (uint256 total) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01180000, 1037618708760) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01180001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01180005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01186001, windowSeconds) }
        uint256 cutoff = block.timestamp - windowSeconds;
        uint256 count  = _head[agentId];
        uint256 entries = count < MAX_ENTRIES ? count : MAX_ENTRIES;
    ...
    function _getUSDValue(address token, uint256 amount) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01190000, 1037618708761) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01190001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01190005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01196001, amount) }
        address feedAddr = _priceFeeds[token];
        require(feedAddr != address(0), "SpendTracker: no price feed for token");
    ...
    function _tokenDecimals(address token) internal pure returns (uint8) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff011a0000, 1037618708762) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff011a0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff011a0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff011a6000, token) }
