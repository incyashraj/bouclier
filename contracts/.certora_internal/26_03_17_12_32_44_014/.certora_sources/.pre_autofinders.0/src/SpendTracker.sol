...
contract SpendTracker is ISpendTracker, AccessControl, Pausable {
    ...
    function _getRollingSpend(bytes32 agentId, uint256 windowSeconds) internal view returns (uint256 total) {
    ...
    function _tokenDecimals(address token) internal pure returns (uint8) {
