...
// ═══════════════════════════════════════════════════════════════════
//  RULE 8: DOMAIN_SEPARATOR is non-zero
//  A meaningful check that the EIP-712 domain was properly initialized.
// ═══════════════════════════════════════════════════════════════════

rule domainSeparatorNonZero {
    bytes32 ds = DOMAIN_SEPARATOR();
    assert ds != to_bytes32(0), "DOMAIN_SEPARATOR should not be zero";
}
