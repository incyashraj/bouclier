...
library MessageHashUtils {
     ...
     * See {ECDSA-recover}.
     */
    function toEthSignedMessageHash(bytes32 messageHash) internal pure returns (bytes32 digest) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008a0000, 1037618708618) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008a0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008a0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008a6000, messageHash) }
     ...
     * See {ECDSA-recover}.
     */
    function toDataWithIntendedValidatorHash(address validator, bytes memory data) internal pure returns (bytes32) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008d0000, 1037618708621) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008d0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008d0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008d6001, data) }
     ...
     * See {ECDSA-recover}.
     */
    function toTypedDataHash(bytes32 domainSeparator, bytes32 structHash) internal pure returns (bytes32 digest) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008c0000, 1037618708620) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008c0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008c0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008c6001, structHash) }
        assembly ("memory-safe") {
            let ptr := mload(0x40)
    ...
    function toDomainSeparator(
        ...
        bytes32 salt
    ) internal pure returns (bytes32 hash) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008f0000, 1037618708623) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008f0001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008f0005, 37449) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff008f6005, salt) }
        return
            toDomainSeparator(
                fields,
    ...
    function toDomainSeparator(
        ...
        address verifyingContract,
        bytes32 salt
    ) internal pure returns (bytes32 hash) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00900000, 1037618708624) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00900001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00900005, 37449) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00906005, salt) }
