...
contract RevocationRegistry is IRevocationRegistry, AccessControl, Pausable {
    ...
    function _revoke(
        ...
        RevocationReason reason,
        string calldata notes
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02280000, 1037618709032) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02280001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02280005, 602) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02286102, notes.offset) }
    ...
    function _reinstate(
        ...
        string calldata notes
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02290000, 1037618709033) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02290001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02290005, 602) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02296102, notes.offset) }
