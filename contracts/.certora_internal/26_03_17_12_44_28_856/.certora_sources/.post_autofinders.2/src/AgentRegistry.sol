...
contract AgentRegistry is IAgentRegistry, Pausable {
    ...
    function _buildDID(address agentWallet) internal view returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fa0000, 1037618708986) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fa0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fa0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fa6000, agentWallet) }
    ...
    function _chainLabel() internal view returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fb0000, 1037618708987) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fb0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fb0004, 0) }
    ...
    function _toHexString(address addr) internal pure returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fc0000, 1037618708988) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fc0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fc0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fc6000, addr) }
    ...
    function _uintToString(uint256 value) internal pure returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fd0000, 1037618708989) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fd0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fd0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01fd6000, value) }
        if (value == 0) return "0";
