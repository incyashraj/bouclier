    ...
    EIP712("BouclierPermissionVault", "1")
{
    ...
    ) internal returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010c0000, 1037618708748) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010c0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010c0005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010c6003, violationType) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010d0000, 1037618708749) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010d0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010d0005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010d6100, callData.offset) }
    ...
    function _slice(bytes memory data, uint256 start) internal pure returns (bytes memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f0000, 1037618708751) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f6001, start) }
    ...
    function _inSelectorArray(bytes4[] storage arr, bytes4 val) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e0000, 1037618708750) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e6001, val) }
        uint256 len = arr.length;
        for (uint256 i; i < len; ++i) {
            if (arr[i] == val) return true;
        }
    ...
    function _inTimeWindow(PermissionScope storage scope) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01110000, 1037618708753) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01110001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01110005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01116000, scope.slot) }
