...
contract SpendTracker is ISpendTracker, AccessControl, Pausable {
    ...
    function _getRollingSpend(bytes32 agentId, uint256 windowSeconds) internal view returns (uint256 total) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02400000, 1037618709056) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02400001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02400005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02406001, windowSeconds) }
    ...
    function _getUSDValue(address token, uint256 amount) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02410000, 1037618709057) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02410001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02410005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02416001, amount) }
    ...
    function _tokenDecimals(address token) internal pure returns (uint8) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02420000, 1037618709058) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02420001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02420005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02426000, token) }
